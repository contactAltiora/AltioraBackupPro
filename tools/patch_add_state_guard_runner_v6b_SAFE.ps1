...
if($txt -match "ABP_STATE_GUARD_V6B"){
  Write-Host "STATE guard already present (V6B). No change."
  exit 0
}
...
Write-Host "OK: STATE guard V6B injected into tools\patch_runner.ps1"
